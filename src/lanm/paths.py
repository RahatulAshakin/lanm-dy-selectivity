...
RESULTS_PROTEINMPNN_ROUND2_SMOKE_DIR = RESULTS_DIR / "proteinmpnn_round2_smoke"
RESULTS_LIGANDMPNN_SMOKE_DIR = RESULTS_DIR / "ligandmpnn_smoke"
RESULTS_LIGANDMPNN_ROUND2_SMOKE_DIR = RESULTS_DIR / "ligandmpnn_round2_smoke"
RESULTS_ROSETTA_SMOKE_DIR = RESULTS_DIR / "rosetta_smoke"
RESULTS_ROSETTA_SCORE_SMOKE_DIR = RESULTS_DIR / "rosetta_score_smoke"
RESULTS_ROSETTA_ROUND2_SCORE_SMOKE_DIR = RESULTS_DIR / "rosetta_round2_score_smoke"
...
RESULTS_OPENMM_SCREENING_DIR = RESULTS_DIR / "openmm_screening"
RESULTS_ROUND2_OPENMM_SCREENING_DIR = RESULTS_DIR / "round2_openmm_screening"
RESULTS_OPENMM_METADYNAMICS_SMOKE_DIR = RESULTS_DIR / "openmm_metadynamics_smoke"
PROTEINMPNN_INPUTS_DIR = RESULTS_DESIGN_INPUTS_DIR / "proteinmpnn"
PROTEINMPNN_ROUND2_INPUTS_DIR = RESULTS_DESIGN_INPUTS_DIR / "proteinmpnn_round2"
LIGANDMPNN_INPUTS_DIR = RESULTS_DESIGN_INPUTS_DIR / "ligandmpnn"
LIGANDMPNN_ROUND2_INPUTS_DIR = RESULTS_DESIGN_INPUTS_DIR / "ligandmpnn_round2"
PROTEINMPNN_BACKBONES_DIR = PROTEINMPNN_INPUTS_DIR / "backbones"
PROTEINMPNN_CAMPAIGNS_DIR = PROTEINMPNN_INPUTS_DIR / "campaigns"
PROTEINMPNN_ROUND2_BACKBONES_DIR = PROTEINMPNN_ROUND2_INPUTS_DIR / "backbones"
PROTEINMPNN_ROUND2_CAMPAIGNS_DIR = PROTEINMPNN_ROUND2_INPUTS_DIR / "campaigns"
...
PROTEINMPNN_ROUND2_SUMMARY_PATH = RESULTS_TABLES_DIR / "proteinmpnn_round2_summary.csv"
PROTEINMPNN_ROUND2_SEQUENCE_CATALOG_PATH = RESULTS_TABLES_DIR / "proteinmpnn_round2_sequence_catalog.csv"
PROTEINMPNN_ROUND2_SMOKE_REPORT_PATH = RESULTS_REPORTS_DIR / "proteinmpnn_round2_smoke.md"
PROTEINMPNN_ROUND2_UNIQUE_SEQUENCES_PATH = RESULTS_TABLES_DIR / "proteinmpnn_round2_unique_sequences.csv"
PROTEINMPNN_ROUND2_SHORTLIST_PATH = RESULTS_TABLES_DIR / "proteinmpnn_round2_shortlist.csv"
PROTEINMPNN_ROUND2_SHORTLIST_REPORT_PATH = RESULTS_REPORTS_DIR / "proteinmpnn_round2_shortlist.md"
...
LIGANDMPNN_ROUND2_INPUT_MANIFEST_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_input_manifest.csv"
LIGANDMPNN_ROUND2_REDESIGN_POSITIONS_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_redesign_positions.csv"
LIGANDMPNN_ROUND2_INPUTS_REPORT_PATH = RESULTS_REPORTS_DIR / "ligandmpnn_round2_inputs.md"
LIGANDMPNN_ROUND2_INPUTS_CONFIG_PATH = REPO_ROOT / "config" / "ligandmpnn_round2_inputs.yaml"
LIGANDMPNN_ROUND2_SMOKE_SUMMARY_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_smoke_summary.csv"
LIGANDMPNN_ROUND2_SEQUENCE_CATALOG_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_sequence_catalog.csv"
LIGANDMPNN_ROUND2_SMOKE_REPORT_PATH = RESULTS_REPORTS_DIR / "ligandmpnn_round2_smoke.md"
LIGANDMPNN_ROUND2_UNIQUE_SEQUENCES_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_unique_sequences.csv"
LIGANDMPNN_ROUND2_SHORTLIST_PATH = RESULTS_TABLES_DIR / "ligandmpnn_round2_shortlist.csv"
LIGANDMPNN_ROUND2_SHORTLIST_REPORT_PATH = RESULTS_REPORTS_DIR / "ligandmpnn_round2_shortlist.md"
LIGANDMPNN_ROUND2_SHORTLIST_FASTA_PATH = RESULTS_FASTA_DIR / "ligandmpnn_round2_shortlist.fa"
...
ROSETTA_ROUND2_SHORTLIST_PATH = REPO_ROOT / "config" / "rosetta_round2_shortlist.yaml"
...
ROSETTA_ROUND2_SCORE_SUMMARY_PATH = RESULTS_TABLES_DIR / "rosetta_round2_score_summary.csv"
ROSETTA_ROUND2_CANDIDATE_RANKING_PATH = RESULTS_TABLES_DIR / "rosetta_round2_candidate_ranking.csv"
ROUND2_MD_RESCREEN_PANEL_PATH = RESULTS_TABLES_DIR / "round2_md_rescreen_panel.csv"
ROSETTA_ROUND2_SCORE_SMOKE_REPORT_PATH = RESULTS_REPORTS_DIR / "rosetta_round2_score_smoke.md"
...
OPENMM_SCREENING_REPLICATES_PATH = RESULTS_TABLES_DIR / "openmm_screening_replicates.csv"
OPENMM_SCREENING_SUMMARY_PATH = RESULTS_TABLES_DIR / "openmm_screening_summary.csv"
OPENMM_SCREENING_PANEL_STATUS_PATH = RESULTS_TABLES_DIR / "openmm_screening_panel_status.csv"
OPENMM_SCREENING_REPORT_PATH = RESULTS_REPORTS_DIR / "openmm_screening.md"
ROUND2_OPENMM_SCREENING_SUMMARY_PATH = RESULTS_TABLES_DIR / "round2_openmm_screening_summary.csv"
ROUND2_OPENMM_SCREENING_PANEL_STATUS_PATH = RESULTS_TABLES_DIR / "round2_openmm_screening_panel_status.csv"
ROUND2_OPENMM_SCREENING_REPORT_PATH = RESULTS_REPORTS_DIR / "round2_openmm_screening.md"
OPENMM_METADYNAMICS_SUMMARY_PATH = RESULTS_TABLES_DIR / "openmm_metadynamics_summary.csv"
OPENMM_METADYNAMICS_PANEL_STATUS_PATH = RESULTS_TABLES_DIR / "openmm_metadynamics_panel_status.csv"
OPENMM_METADYNAMICS_REPORT_PATH = RESULTS_REPORTS_DIR / "openmm_metadynamics_smoke.md"
REDESIGN_ROUND2_CONFIG_PATH = REPO_ROOT / "config" / "redesign_round2.yaml"
...
def ensure_runtime_directories() -> None:
    ...
    for path in (
        ...
        PROTEINMPNN_ROUND2_BACKBONES_DIR,
